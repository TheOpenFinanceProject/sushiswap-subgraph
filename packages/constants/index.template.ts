...
export const SUSHI_USDT_PAIR = "{{ sushi_usdt_pair }}{{^sushi_usdt_pair}}0x0000000000000000000000000000000000000000{{/sushi_usdt_pair}}";
...
// Bentobox constants
export const BENTOBOX_ADDRESS = Address.fromString("{{ bentobox_address }}{{^bentobox_address}}0x0000000000000000000000000000000000000000{{/bentobox_address}}");
...
// MiniChef
export const MINI_CHEF_ADDRESS = Address.fromString("{{ minichef_address }}{{^minichef_address}}0x0000000000000000000000000000000000000000{{/minichef_address}}");
...
>>>>>>> b353d5f01087afc6dc2f003ac6ae384fd12bfe43
